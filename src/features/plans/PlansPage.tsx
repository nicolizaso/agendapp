      ...
      <header className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-ink-400">
            Progresión automática: el peso sube según el equipamiento cada 3 semanas.
          </p>
        </div>
        {plans.length > 0 && (
            ...
            >
              <div>
                ...
                <p className="mt-1 text-xs text-ink-500">
                  Semana 0: {new Date(plan.startDate).toLocaleDateString('es-AR', { day: 'numeric', month: 'short' })}
                </p>
