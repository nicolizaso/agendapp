...
export function CalendarSection() {
    ...
    return (
        <div className="space-y-4 animate-in slide-in-from-bottom-4 duration-700 delay-100">
             <h2 className="text-xl font-bold text-stone-200 capitalize">{format(today, 'MMMM yyyy', { locale: es })}</h2>
             <div className="grid grid-cols-7 gap-1 text-center text-xs text-rose-400 mb-2">
