                    ...
                    return (
                        ...
                        >
                            ...
                            <input
                                ...
                                className="w-full bg-neutral-900 border border-neutral-700 rounded-lg py-3 text-center text-lg font-bold text-white focus:border-red-500 focus:outline-none disabled:opacity-50"
                                inputMode="decimal"
                            />
